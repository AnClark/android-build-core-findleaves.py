  ...
  for rootdir in dirlist:
    ...
    for root, dirs, files in os.walk(rootdir, followlinks=True):
      ...
      if filename in files:
        ...
        # ANCLARK MODIFY: Print out find state. Running a script without giving any status text is really annoying.
        sys.stderr.write("[FOUND] " + str(os.path.join(root, filename)) + '\n')
...
def main(argv):
  ...
  sys.stderr.write("[ Findleaves process started! Ready, GO! ]\n")
